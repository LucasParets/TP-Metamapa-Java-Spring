package ar.utn.ba.ddsi.tpa.fuente_dinamica.configs;
    ...
    SecurityFilterChain api(HttpSecurity http, JwtAuthenticationConverter jwtConv) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/dinamica/hechos", "/api/dinamica/hechos/**").permitAll()
                        .requestMatchers("/api/dinamica/mis-hechos").hasRole("USER")
                        .requestMatchers("/api/dinamica/admin/**").hasRole("ADMIN")
