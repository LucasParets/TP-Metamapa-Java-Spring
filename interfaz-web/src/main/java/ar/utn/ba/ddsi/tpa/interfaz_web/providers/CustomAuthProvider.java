package ar.utn.ba.ddsi.tpa.interfaz_web.providers;

import ar.utn.ba.ddsi.tpa.interfaz_web.dtos.AuthResponseDTO;
import ar.utn.ba.ddsi.tpa.interfaz_web.dtos.RolesDTO;
...
public class CustomAuthProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        try {
            ...
            RolesDTO rolesPermisos = externalAuthService.getRolesPermisos(authResponse.getAccessToken());
